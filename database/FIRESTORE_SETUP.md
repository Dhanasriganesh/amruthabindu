...
| `orders` | auto | `order_id`, `payment_id`, `items`, `totals`, `shipping_address`, `guest_email`, `user_id`, `nimbuspost_order_id`, `nimbuspost_shipment_id`, `tracking_number`, `fulfillment_status`, `created_at` |
