    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-gray-800 leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold text-gray-900">Privacy Guarantee</h2>
          <p>
          ...
          <p>
            amruthabindu.in operates a strict privacy policy and we are committed to being transparent about how we use cookies on our website.
          </p>

          <h3 className="text-xl font-semibold text-gray-900">Why are cookies important?</h3>
          <p>
          ...
          <h3 className="text-xl font-semibold text-gray-900">What is a Cookie?</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Analytics</strong> – used for performance measurement to understand how many people visit our websites, how they navigate, and what content is popular.</li>
            <li><strong>Advertising</strong> – enable us and partners to serve relevant advertisements on our sites and others.</li>
          </ul>
          <p>
            Additionally, you can see how Google Analytics uses cookie information by visiting <span className="break-all">www.google.com/policies/privacy/partners</span>.
          </p>
          <p>
            To ensure compliance with our policies, we restrict the use of third-party cookies to trusted partners. We also use third party information from third party sources to enable us deliver advertising. These sources are validated by third party providers.
          </p>
          <p>
            You may change settings related to Privacy and Security in your browser. To delete cookies from your browser, refer to your browser’s settings (for example, in Chrome under Settings → Privacy and Security).
          </p>
        </div>
      </div>
    </div>
