...
function getTrackingLink(trackingNumber) {
  ...
  return `https://nimbuspost.com/tracking/?awb=${encodeURIComponent(trackingNumber)}`
}
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          ${trackingNumber ? `
            <div style="background-color: #f0f0f0; padding: 15px; border-radius: 5px; margin: 20px 0;">
              ...
              <p style="margin: 5px 0 0 0; font-size: 14px;">Track your order at: <a href="${trackingLink}" target="_blank">Nimbuspost Tracking</a></p>
            </div>
          ` : ''}
          <p>Thank you for choosing Amrutha Bindu!</p>
        </div>
