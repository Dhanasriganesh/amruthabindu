const DEFAULT_UNIT_KG = parseFloat(process.env.NIMBUSPOST_DEFAULT_WEIGHT || process.env.SHIPPING_DEFAULT_WEIGHT || '0.5')
const MIN_BILLABLE_KG = parseFloat(process.env.NIMBUSPOST_MIN_WEIGHT || process.env.SHIPPING_MIN_WEIGHT || '0.5')
...
/** Round up to 0.5 kg billing slabs (minimum 500 g). */
